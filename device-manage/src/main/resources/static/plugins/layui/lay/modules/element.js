...
;layui.define("jquery", function (i) {
    ...
    s.prototype.set = function (i) {
        ...
        var l = ".layui-tab-title", e = a(".layui-tab[lay-filter=" + i + "]"), n = e.children(l), s = n.children(".layui-tab-bar"), o = e.children(".layui-tab-content"),
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child", h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
        tabClick: function (i, t, s) {
            var o = s || a(this), t = t || o.parent().children("li").index(o), c = o.parents(".layui-tab").eq(0), r = c.children(".layui-tab-content").children(".layui-tab-item"), u = o.find("a"),
                d = c.attr("lay-filter");
            ...
            a(".layui-tab").each(function () {
                var s = a(this), o = s.children(".layui-tab-title"), c = (s.children(".layui-tab-content").children(".layui-tab-item"), 'lay-stope="tabmore"'),
        ...
        var l = {
            tab: function () {
                ...
                var i = 200, l = {}, e = {}, s = {}, p = function (o, c, r) {
                    ...
                    c.hasClass(u) ? o.css({top: y.position().top, height: y.children("a").height(), opacity: 1}) : (p.addClass(f), o.css({
                ...
                a(o).each(function (t) {
                    ...
                    o.find("." + r)[0] || (o.append(f), v.on("mouseenter", function () {
                        ...
                        clearTimeout(l[t]), s[t] = setTimeout(function () {
                            o.hasClass(u) ? f.css({height: 0, top: f.position().top + f.height() / 2, opacity: 0}) : f.css({width: 0, left: f.position().left + f.width() / 2, opacity: 0})
                        }, i)
                    })), v.each(function () {
                ...
                a("." + i).each(function () {
                    ...
                    l.css("width", e), t.attr("lay-showPercent") && setTimeout(function () {
                        ...
                        // var a = l.width() / t.width() * 100;
                        // console.log("l.width():" + l.width() + "----t.width():" + t.width() + "结果:" + a);
