package com.device.manage.core.constant;

/**
 * @author Created by Administrator on 2017/6/21.
 *         基础变量
 */
public class BasicConstant {
	...
	public static final String BACK_USER_INFO = "backUserInfo";
	...
	public static final String CHANGE_PASSWORD_FAILED = "修改密码成功";

	public static final String IDENTITY_EXPIRED = "身份已过期，请重新登录";
	 ...
	 * 工单操作
	 */
	public static final  String CREATE_WORK_ORDER = "创建工单";
	public static final  String QUERY_WORK_ORDER = "查询工单";
	public static final  String CUSTOMER_SERVICE_ENQUIRIES = "客服用户查询";
	public static final  String HANDLER_WORK_ORDER = "创建工单";
